...
public class TreatPage {
    public void addTreatment(){
        ...
        $(byText("Geburtshilfe")).waitUntil(appear, 5000).click();  // Select reason
        $(By.xpath("(//input)[6]")).val(dateFormat + " ABC");
        $(By.xpath("(//input)[7]")).click();
        $(By.xpath("(//div)[18]")).waitUntil(appear, 5000).click();  // Select animal type
